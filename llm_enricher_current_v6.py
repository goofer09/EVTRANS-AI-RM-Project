...
class SubComponentEnricher:
    ...
    def enrich(self, hs_code: str, description: str) -> list:
        ...
        """
        # ------------------------------
        # STARTING PROMPT (can refine later)
        # ------------------------------
...
Exclude tools, software, sensors, electronic control units, fasteners,
and non-essential accessories unless they are core to the product.
...
- Do NOT mention EVs, ICEs, or future technology
"""
...
def enrich_prompt(prompt_text: str) -> list:
    ...
    """
    # Extract HS code and description from prompt
    import re
